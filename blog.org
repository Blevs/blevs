...
*** Bird's Eye View
    ...
    #+begin_src clojure :results output html
...
**** Making the Rules
     ...
     #+begin_src clojure :results output html :exports none
       ...
       (defn preprocess [sample-path tile-size & {:keys [permutations?]}]
         (->> (sample->tiles sample-path tile-size :permutations? true)
              frequencies
              transpose
       ...
       (println (first ((calculate-overlaps tiles))))
     #+end_src
